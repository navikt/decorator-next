    ...
    const c = Symbol(),
        ...
        y = (e, u, c, b) => {
            ...
            "audioTracks" in b.HTMLMediaElement.prototype &&
                ...
                (C.createObjectURL = (e) =>
                    n(b, ["URL", "createObjectURL"], [e])),
                (C.revokeObjectURL = (e) =>
                    n(b, ["URL", "revokeObjectURL"], [e]));
        },
        L = new Map();
    e.f = (e, t, s, n, r) => {
        r.map((e) => {
