...
((e) => {
    const t = () => {},
                        ...
                        (n =
                            null ===
                                (r =
                                    null == e
                                        ? void 0
                                        : e.__zone_symbol__originalInstance) ||
                            void 0 === r
                                ? void 0
        ...
        w = (e, t, r, n, i) => {
            if ((r = f[e]) && r.U) {
                if (e === t) return r.U;
                if (((n = r.U.document), "d" === (i = t.split(".").pop())))
                    return n;
    ...
    const A = (t) => {
            ...
            return (
                (L =
                    (null === (r = e.top) || void 0 === r ? void 0 : r.Error) ||
                    L),
                t instanceof L
            );
        },
        ...
        O = (e, { V: t, w: r, L: n }, i) => (
            (i = m.get(n)) ||
                ((i = function (...i) {
                    e.postMessage([
                        9,
                        { V: t, w: r, L: n, R: M(t, this), b: M(t, i) },
                    ]);
                }),
                m.set(n, i)),
            i
            ...
            if (!y.has(r)) {
                ...
                (i.pushState = (e, t, r) => {
                    ...
                    (i.replaceState = (e, t, r) => {
                        p(e, t, r),
                            c(d(1, e, null == r ? void 0 : r.toString()));
                    }),
                        ...
                        ((e, t, r) => {
                            void 0 !== t[r] &&
                                e.push([
                                    r,
                                    "Object",
                                    Object.keys(t[r].prototype).map((e) => [
                                        e,
                                        6,
                                    ]),
                                    12,
